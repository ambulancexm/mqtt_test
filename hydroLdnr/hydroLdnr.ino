...
const char *user_broker ="bereziat.th@gmail.com";
const char *pwd_broker ="admin";
...
void reconnect()
{
  ...
  while (!client.connected())
  {
    ...
    // Attempt to connect
    if (client.connect(clientId.c_str(),user_broker,pwd_broker))
    {
...
void loop()
{
  ...
  if (now - lastMsg > 60000)
  {
    ...
    client.publish("bereziat.th@gmail.com/hydro",msg);
